...
| 4 Evaluate | `evaluate.html` | The question chain, the group's theory of change with the question each link raises, fake pilot results against the group's measures, and the closing question "So was it a success?". A builder for the additional data needed, with a guide to data sources, sits under "If there is time" | A verdict, discussed in the room. Optionally, pilot results plus the additional data needed |
